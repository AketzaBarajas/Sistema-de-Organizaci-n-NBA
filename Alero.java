public class Alero extends Jugador {
    protected static final double ALTURA_MAX = 2.09; //Altura máxima requerida (metros)
    protected static final double ALTURA_MIN = 2.03;//Altura mínima requerida (metros)

    //Constructor
    public Alero(String nombre, int dorsal, double altura){
    ...
    public String toString(){
        return "Jugador alero: " + super.toString();
    }
}
